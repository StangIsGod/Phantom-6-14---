...
namespace ENTITY
{
	...
	static Vector3 GET_ENTITY_COORDS2(Entity *entity, BOOL unkBool) { return invoke<Vector3>(0x1647F1CB, entity, unkBool); } // 0x1647F1CB
	...
	static void DELETE_ENTITY2(Entity EntityHandle) { invoke<Void>(0xFAA3D236, EntityHandle); } // 0xFAA3D236
...
namespace CAM
{
	...
	static Cam GET_RENDERING_CAM() { return invoke<Cam>(0x0FCF4DF1); } // 0x0FCF4DF1
	...
	static void SET_CAM_MOTION_BLUR_STRENGTH(Cam cam, float strength) { invoke<Void>(0xFD6E0D67, cam, strength); } // 0xFD6E0D67
...
namespace SCRIPT
{
	...
	static int TRIGGER_SCRIPT_EVENT2(int p0, int* p1, int p2, int p3) { invoke<int>(0x54763B35, p0, p1, p2, p3); } // 0x54763B35
...
namespace NETWORK
{
	...
	static Any NETWORK_CREATE_SYNCHRONISED_SCENE1(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<Any>(0xB06FE3FE, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9, p10, p11); } // 0xB06FE3FE
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE1(Ped ped, int netScene, char *animDictionary, char *animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate, Any p9) { invoke<Void>(0xB386713E, ped, netScene, animDictionary, animationName, speed, speedMultiplier, duration, flag, playbackRate, p9); } // 0xB386713E
...
void setPlayerStat2(int playerIndex, int statIndex, float valueIndex)
{
...
OPD_s NETWORK_INCREMENT_STATS_t = { 0x12D137C, 0x1C85330 };
...
int _entityAddressIndexFunc = 0x473FE4;
int(*GetEntityAddressIndex)(int handle) = (int(*)(int))&_entityAddressIndexFunc;
